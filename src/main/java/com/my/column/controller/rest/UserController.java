...
public class UserController {
    ...
    public Result register(@RequestParam("loginName") String loginName,
        ...
        System.out.println("验证码"+verifyCode.toLowerCase());
        System.out.println("用户输入的验证码"+kaptchaCode);
        if (!StringUtils.hasLength(kaptchaCode) || !verifyCode.toLowerCase().equals(kaptchaCode.toLowerCase())) {
...
//        String kaptchaCode = httpSession.getAttribute(Constants.VERIFY_CODE_KEY) + "";
        String kaptchaCode = (String) httpSession.getAttribute(Constants.VERIFY_CODE_KEY);
