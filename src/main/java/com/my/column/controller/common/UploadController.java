...
//        File fileDirectory = new File(Constants.FILE_UPLOAD_DIC);
        ...
        //创建文件
        File destFile = new File(ResourceUtils.getURL("classpath:static").getPath()+"/upload/"+ newFileName);
...
//            System.out.println(SystemUtil.getHost(new URI(httpServletRequest.getRequestURL() + "")) );
